...
在 iteration-5 fixes 已通过独立 review 后，重新全面评审当前所有 `skills/*/SKILL.md` 的 prompt 质量，并逐项评分。
...
- 当前工作区所有 `skills/*/SKILL.md`，预期扫描 36 个当前 skill，实际数量以命令结果为准。
