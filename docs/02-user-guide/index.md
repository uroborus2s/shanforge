...
`02-user-guide` 现在只保留三个内容文档：

1. [使用指南](./user-guide.md)
2. [提示词速查](./prompt-templates.md)
3. [命令速查](./command-cheatsheet.md)
...
| `command-cheatsheet.md` | 每个 `factory-*` 命令做什么、什么时候用、怎么调用、预期生成什么 | 想从自然语言下钻到具体命令时 |
...
3. 最后把 [命令速查](./command-cheatsheet.md) 当参考手册

### 如果你已经会用自然语言，但总忘命令

1. 先读 [命令速查](./command-cheatsheet.md)
2. 再回看 [提示词速查](./prompt-templates.md)

### 如果你知道命令，但总写不好 Prompt
