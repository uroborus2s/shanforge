...
| 已纳管项目升级 docs 到最新规范 | 先检查并执行 docs 标准升级 | [19](#19-已纳管项目升级-docs-到最新源文档标准) | 按需迁移旧 docs 结构、刷新索引和目录页，并输出人工复核点 |
| 批量扫描并通知项目负责人刷新 docs | 先批量检查，再逐个生成通知 | [20](#20-批量扫描并通知项目负责人刷新-docs) | 得到项目清单、状态汇总和可直接转发的通知模板 |
...
<a id="19-已纳管项目升级-docs-到最新源文档标准"></a>

## 19. 已纳管项目升级 docs 到最新源文档标准

### 什么时候用

- 项目已经有 `AGENTS.md`、`GEMINI.md`、`.factory/project.json` 和 `docs/`
