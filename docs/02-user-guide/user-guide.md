...
开发或计划更新会先说明当前阶段、任务、已完成结果、剩余范围、阻塞和唯一下一动作。产品进度按已批准 WBS 和任务卡展示为“已完成、进行中、未开始、阻塞”；已完成项应附可观察结果和验证状态。缺少完整 WBS 或批准总数时，状态会写“无法计算”，不会猜测百分比。评审、系统治理和提交可以单列为交付状态，但不等于产品功能完成。
