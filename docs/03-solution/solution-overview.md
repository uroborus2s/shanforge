...
- 看正式需求边界：读 [prd.md](/Users/uroborus/shanforge/docs/02-requirements/prd.md)
- 看详细系统分层和数据流：读 [system-architecture.md](/Users/uroborus/shanforge/docs/03-solution/system-architecture.md)
- 看工程规则和技术画像：读 [technical-selection.md](/Users/uroborus/shanforge/docs/03-solution/technical-selection.md)
- 看模块职责和禁止耦合：读 [module-boundaries.md](/Users/uroborus/shanforge/docs/03-solution/module-boundaries.md)
- 看实际使用方式：读 [user-guide.md](/Users/uroborus/shanforge/docs/08-handover/user-guide.md)
- 看高主动性、自主性和恢复机制：读 [agent-motivation-autonomy-integration.md](/Users/uroborus/shanforge/docs/09-evolution/agent-motivation-autonomy-integration.md)
