...
- 进入实现或规则变更前必须阅读本文件。
- 技术栈或核心入口变更后，必须同步更新：
  - [系统架构设计](/Users/uroborus/shanforge/docs/03-solution/system-architecture.md)
  - [模块边界文档](/Users/uroborus/shanforge/docs/03-solution/module-boundaries.md)
  - [API 设计文档](/Users/uroborus/shanforge/docs/03-solution/api-design.md)
  - [用户指南](/Users/uroborus/shanforge/docs/08-handover/user-guide.md)
