...
- 安装结果、构建状态、测试结论、最新运行情况等易变事实，写入 `.factory/project.json`、`.factory/memory/current-state.md` 和 `docs/01-discovery/current-state-analysis.md`
...
2. 当前安装、构建、测试、运行验证结论写入 `.factory/project.json`、`.factory/memory/current-state.md` 和 `docs/01-discovery/current-state-analysis.md`
