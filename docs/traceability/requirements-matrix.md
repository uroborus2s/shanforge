...
| `REQ-006` | 提供带自然语言速查表的用户使用文档 | `user-guide.md`, `historical-project-prompt-templates.md`, `api-design.md`, `prd.md` | `MOD-001`, `MOD-003` | `API-001`, `API-002`, `API-005` | `TASK-004` 用户指南整理 | 用户路径走查 | 已完成基线 |
...
|---|---|---|---|---|
| `NFR-001` | 新协作者 10 分钟内定位关键入口 | `docs/README.md`, `user-guide.md` | 人工走查 | 文档维护者 |
...
| `GAP-002` | 尚未补齐发布和运维正式文档 | 发布/运维文档 | 仓库维护者 | 后续阶段 |
