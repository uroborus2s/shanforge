...
const SHANFORGE_VERSION = readShanforgeVersion();
...
<html>
<head><meta charset="utf-8"><title>Shanforge 头脑风暴伴侣</title>
<style>
...
<body><!-- BRANDING --><h1>Shanforge 头脑风暴伴侣</h1>
...
function brandMarkup() {
  const version = escapeHtmlText(SHANFORGE_VERSION);
  return '<div class="brand"><span class="brand-copy">Shanforge 头脑风暴伴侣 v' + version + '</span></div>';
}
