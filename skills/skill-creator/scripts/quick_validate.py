...
from utils import extract_frontmatter, parse_frontmatter
...
def validate_skill(skill_path):
    ...
    if allowed_tools and not isinstance(allowed_tools, (str, list)):
        return False, f"allowed-tools must be a string or list, got {type(allowed_tools).__name__}"

    metadata = frontmatter.get('metadata')
    if metadata and not isinstance(metadata, (str, dict)):
        return False, f"metadata must be a string or dictionary, got {type(metadata).__name__}"
